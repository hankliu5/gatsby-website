...
const styles = theme => ({
  ...
  listItemText: {
    ...
    "& h1": {
      ...
      [`@media (min-width: ${theme.mediaQueryThresholds.M}px)`]: {
        fontSize: `${theme.navigator.sizes.postsListItemH1Font * theme.navigator.sizes.fontIncreaseForM}em`
      },
      [`@media (min-width: ${theme.mediaQueryThresholds.L}px)`]: {
        fontSize: `${theme.navigator.sizes.postsListItemH1Font * theme.navigator.sizes.fontIncreaseForL}em`,
        ".moving-featured &, is-aside &": {
          fontSize: "1em",
          fontWeight: 400
        }
    ...
    "& h2": {
      ...
      [`@media (min-width: ${theme.mediaQueryThresholds.M}px)`]: {
        fontSize: `${theme.navigator.sizes.postsListItemH2Font * theme.navigator.sizes.fontIncreaseForM}em`
      },
      [`@media (min-width: ${theme.mediaQueryThresholds.L}px)`]: {
        fontSize: `${theme.navigator.sizes.postsListItemH2Font * theme.navigator.sizes.fontIncreaseForL}em`,
        ".moving-featured &, is-aside &": {
          display: "none"
        }
      }
