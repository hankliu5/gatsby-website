...
const styles = theme => ({
  navigator: {
    ...
    transition: "left .9s",
    width: "100%",
    [`@media (max-width: ${theme.mediaQueryThresholds.L - 1}px)`]: {
      "&.is-aside": {
        left: "-100%"
      },
      ".is-featured": {
    ...
    [`@media (max-width: ${theme.mediaQueryThresholds.L}px)`]: {
      "&.is-feature": {
        transition: "left .9s",
      ...
      "&.moving-aside": {
        ...
        width: `calc(100vw - ${theme.info.sizes.width - 60}px`,
        top: 0
      },
      "&.resizing-aside": {
        transition: "none",
...
class Navigator extends React.Component {
  ...
  render() {
    ...
    return (
      <nav className={`${classes.navigator} ${navigatorPosition ? navigatorPosition : ""} 
